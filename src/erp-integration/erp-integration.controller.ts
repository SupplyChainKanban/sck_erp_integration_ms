...
export class ErpIntegrationController {
  ...
  @MessagePattern('createErpIntegration')
  create(@Payload() createErpIntegrationDto: CreateErpIntegrationDto) {
    return this.erpIntegrationService.create(createErpIntegrationDto);
  }
